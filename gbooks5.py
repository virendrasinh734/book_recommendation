...
logging.basicConfig(filename="process_10_n.log", format='%(asctime)s - %(levelname)s - %(message)s', level=logging.DEBUG)
books = build('books', 'v1', developerKey=' ')  

with open('.\jsons\part_10.json', 'r') as json_file:
