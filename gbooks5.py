...
logging.basicConfig(filename="process_15.log", format='%(asctime)s - %(levelname)s - %(message)s', level=logging.DEBUG)
books = build('books', 'v1', developerKey='AIzaSyCV6LLIKHr4brc29gJB4i89a566PY-IR88')  

with open('./jsons/part_15.json', 'r') as json_file:
